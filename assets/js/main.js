...
sr.reveal(
  ".hero__title, .features__container, .companies__pretitle, .companies__title, .testimonials__title, .newsletter__container, .footer__container"
);
...
sr.reveal(".section-primary__text", { origin: "left" });
